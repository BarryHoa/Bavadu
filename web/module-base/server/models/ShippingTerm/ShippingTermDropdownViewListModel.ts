...
class ShippingTermDropdownViewListModel extends BaseViewListModel<
...
> {
  ...
  protected declarationMappingData(row: any): ShippingTermDropdownOption {
    const name =
...
export default ShippingTermDropdownViewListModel;
