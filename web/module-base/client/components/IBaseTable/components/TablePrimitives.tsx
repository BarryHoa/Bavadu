...
export const IBaseTableColumn = HeroUITableColumn;
export const IBaseTableBody = HeroUITableBody;
export const IBaseTableRow = HeroUITableRow;
export const IBaseTableCell = HeroUITableCell;
