...
export const table_compliance_report = pgTable(
  "hrm_compliance_reports",
  {
    id: uuid("id")
      .primaryKey()
  ...
  (table) => [
    index("hrm_compliance_reports_number_idx").on(table.reportNumber),
    index("hrm_compliance_reports_type_idx").on(table.reportType),
    index("hrm_compliance_reports_period_idx").on(table.reportingPeriod),
    index("hrm_compliance_reports_status_idx").on(table.status),
  ]
);
