...
export const table_workflow = pgTable(
  "hrm_workflows",
  {
    id: uuid("id")
      .primaryKey()
...
export const table_workflow_instance = pgTable(
  "hrm_workflow_instances",
  {
    id: uuid("id")
      .primaryKey()
      .default(sql`uuid_generate_v7()`),
...
export const table_workflow_approval = pgTable(
  "hrm_workflow_approvals",
  {
    id: uuid("id")
      .primaryKey()
      .default(sql`uuid_generate_v7()`),
