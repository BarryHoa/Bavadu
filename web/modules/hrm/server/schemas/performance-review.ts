...
export const table_performance_review = pgTable(
  ...
  (table) => [
    index("hrm_performance_reviews_employee_idx").on(table.employeeId),
    index("hrm_performance_reviews_reviewer_idx").on(table.reviewerId),
    index("hrm_performance_reviews_type_idx").on(table.reviewType),
    index("hrm_performance_reviews_status_idx").on(table.status),
  ]
);
