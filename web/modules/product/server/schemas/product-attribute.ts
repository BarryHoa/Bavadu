...
export const table_product_attribute = pgTable(
  "product_attributes",
  {
  ...
  (table) => [
    index("product_attributes_variant_idx").on(table.productVariantId),
    index("product_attributes_code_idx").on(table.code),
  ]
);
