...
export type ProductTbProductAttribute =
  typeof product_tb_product_attributes.$inferSelect;
export type NewProductTbProductAttribute =
  typeof product_tb_product_attributes.$inferInsert;
