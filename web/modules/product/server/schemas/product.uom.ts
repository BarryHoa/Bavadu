...
export type ProductTbUnitOfMeasure =
  typeof product_tb_units_of_measure.$inferSelect;
export type NewProductTbUnitOfMeasure =
  typeof product_tb_units_of_measure.$inferInsert;
...
export type ProductTbUomConversion =
  typeof product_tb_uom_conversions.$inferSelect;
export type NewProductTbUomConversion =
  typeof product_tb_uom_conversions.$inferInsert;
