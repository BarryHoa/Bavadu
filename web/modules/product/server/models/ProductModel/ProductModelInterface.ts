...
import { ListParamsRequest, ListParamsResponse, ParamFilter } from "@/module-base/server";
...
export interface ProductModelInterface {
    getProducts(filter: ListParamsRequest<ProductFilter>): Promise<ListParamsResponse<ProductVariantElm>>;
