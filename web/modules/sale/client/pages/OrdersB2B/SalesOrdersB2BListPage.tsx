    ...
    () => [
      {
        ...
        render: (value, row) => {
          ...
          return (
            <LinkAs href={`/workspace/modules/sale/orders-b2b/view/${row.id}`}>
              {row.code}
            </LinkAs>
          );
        },
      ...
      },
      {
        ...
        render: (_, row) => {
          ...
          const viewLink = `/workspace/modules/sale/orders-b2b/view/${row.id}`;
          return (
            <ActionMenu
              actions={[
                {
        ...
        actionsRight={[
          {
            ...
            color: "primary",
            props: {
              href: "/workspace/modules/sale/orders-b2b/create",
            },
          },
        ]}
      />
