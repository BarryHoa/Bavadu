    ...
    () => [
      {
        ...
        render: (value, row) => {
          ...
          return (
            <LinkAs href={`/workspace/modules/sale/deliveries/view/${row.id}`}>
      ...
      },
      {
        ...
        render: (_, row) => {
          ...
          const viewLink = `/workspace/modules/sale/deliveries/view/${row.id}`;
          return (
            <ActionMenu
              actions={[
                {
        ...
        actionsRight={[
          {
            ...
            color: "primary",
            props: {
              href: "/workspace/modules/sale/deliveries/create",
            },
          },
        ]}
      />
