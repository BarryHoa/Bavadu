...
CREATE TABLE "md_base"."role_permissions" (
	...
	"permission_id" uuid, -- Optional: reference to permission registry (if exists)
...
CREATE INDEX "role_permissions_permission_key_idx" ON "md_base"."role_permissions"("permission_key");
