...
-- Tạo bảng employees (HR extension of user; personal data on user)
...
ALTER TABLE "mdl_hrm"."employees"
	ADD CONSTRAINT "employees_manager_id_base_users_id_fk"
...
CREATE INDEX IF NOT EXISTS "employees_type_idx" ON "mdl_hrm"."employees"("type");
